!(function (e) {
    function n() {
        ...
        (n = r.indexOf("Opera")) != -1
            ? ((i = "Opera"), (o = r.substring(n + 6)), (n = r.indexOf("Version")) != -1 && (o = r.substring(n + 8)))
            : (n = r.indexOf("MSIE")) != -1
            ? ((i = "Microsoft Internet Explorer"), (o = r.substring(n + 5)))
            : (n = r.indexOf("Trident")) != -1
            ? ((i = "Microsoft Internet Explorer"), (o = (n = r.indexOf("rv:")) != -1 ? r.substring(n + 3) : "0.0"))
            : (n = r.indexOf("Chrome")) != -1
            ? ((i = "Chrome"), (o = r.substring(n + 7)))
            : (n = r.indexOf("Android")) != -1
            ? ((i = "Android"), (o = r.substring(n + 8)))
            : (n = r.indexOf("Safari")) != -1
            ? ((i = "Safari"), (o = r.substring(n + 7)), (n = r.indexOf("Version")) != -1 && (o = r.substring(n + 8)))
            : (n = r.indexOf("Firefox")) != -1
            ? ((i = "Firefox"), (o = r.substring(n + 8)))
            : (e = r.lastIndexOf(" ") + 1) < (n = r.lastIndexOf("/")) && ((i = r.substring(e, n)), (o = r.substring(n + 1)), i.toLowerCase() == i.toUpperCase() && (i = navigator.appName)),
            (t = o.indexOf(";")) != -1 && (o = o.substring(0, t)),
            (t = o.indexOf(" ")) != -1 && (o = o.substring(0, t)),
            (a = parseInt("" + o, 10)),
            isNaN(a) && ((o = "" + parseFloat(navigator.appVersion)), (a = parseInt(navigator.appVersion, 10)));
        var s = new Object();
    ...
    function o(e, n, t) {
        ...
        i.open("GET", n + t, !0),
            ...
            (i.onload = function () {
                ...
                if (
                    (num_missing--,
                    FS.createDataFile("pat/", t, new Int8Array(i.response), !0, !0),
                    MIDIjs.message_callback && num_missing > 0 && MIDIjs.message_callback("Loading instruments: " + num_missing),
                    j("Loading instruments: " + num_missing),
                    0 == num_missing)
                ) {
                    ...
                    (L = Module.ccall("mid_song_load", "number", ["number", "number"], [stream, a])),
                        ...
                        Module.ccall("mid_song_start", "void", ["number"], [L]),
                        (P = E.createScriptProcessor(N, 0, 1)),
                        (w = Module._malloc(2 * N)),
                        (P.onaudioprocess = r),
    ...
    function c(e) {
        ...
        n.open("GET", e, !0),
            ...
            (n.onload = function () {
                ...
                j("MIDI file loaded: " + e),
                    (midiFileArray = new Int8Array(n.response)),
                    (x = Module._malloc(midiFileArray.length)),
                    Module.writeArrayToMemory(midiFileArray, x),
                ...
                if (
                    ((L = Module.ccall("mid_song_load", "number", ["number", "number"], [stream, i])),
                    (rval = Module.ccall("mid_istream_close", "number", ["number"], [stream])),
                    (num_missing = Module.ccall("mid_song_get_num_missing_instruments", "number", ["number"], [L])),
                    0 < num_missing)
                )
    ...
    function M(e) {
        ...
        n ? n.lastChild.setAttribute("src", e) : ((n = document.createElement("div")), n.setAttribute("id", "scorioMIDI"), (n.innerHTML = '&nbsp;<bgsound src="' + e + '" volume="100"/>'), document.body.appendChild(n)),
            (C = setInterval(I, q)),
            (F = 0),
            (P = n),
            j("Playing " + e + " ...");
    ...
    function _(e) {
        ...
        n
            ...
            : ((n = document.createElement("div")), n.setAttribute("id", "scorioMIDI"), (n.innerHTML = '<object data="' + e + '" autostart="true" volume="100" type="audio/mid"></object>'), document.body && document.body.appendChild(n)),
            (C = setInterval(I, q)),
            (F = 0),
            (P = n),
            j("Playing " + e + " ...");
    ...
    var G = n();
    try {
        ("iPhone" == G.platform || "iPod" == G.platform || "iPad" == G.platform) && G.majorVersion <= 6
            ? (A = "none")
            : ((window.AudioContext = window.AudioContext || window.webkitAudioContext), (E = new AudioContext()), (A = "WebAudioAPI"));
    } catch (W) {
    ...
    (e.MIDIjs = new Object()),
        ...
        (e.MIDIjs.unmute_iOS_hack = a),
        "WebAudioAPI" == A
            ? ((e.MIDIjs.play = u), (e.MIDIjs.stop = b), (V = "audioMethod: WebAudioAPI, sampleRate (Hz): " + E.sampleRate + ", audioBufferSize (Byte): " + N), (e.MIDIjs.noteOn = m), (e.MIDIjs.startSynth = d))
            : "bgsound" == A
            ? ((e.MIDIjs.play = M), (e.MIDIjs.stop = v), (V = "audioMethod: &lt;bgsound&gt;"))
            : "object" == A
            ? ((e.MIDIjs.play = _), (e.MIDIjs.stop = y), (V = "audioMethod: &lt;object&gt;"))
            : ((e.MIDIjs.play = function (e) {}), (e.MIDIjs.stop = function (e) {}), (V = "audioMethod: No method found")),
        "Microsoft Internet Explorer" == G.browserName && "https:" == location.protocol.toLowerCase() && M("http://" + B + "midi/silence.mid");
})(this);
